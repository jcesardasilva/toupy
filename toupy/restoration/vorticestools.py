...
__all__ = ["cart2pol", "pol2cart", "rmvortices", "get_phase_novort"]
...
def get_phase_novort(img_phase, residues):
    """
...
def rmvortices(img_in, to_ignore=100):
    ...
    Note
    ----
    An eventual linear phase ramp will be remove from the input phase
    image
    """
    # remove phase ramp
    ...
    # remove vortices
    img_phase_novort, xres, yres = get_phase_novort(img_phase_vort, residues)
