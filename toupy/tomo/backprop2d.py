...
#def backpropagation2d(
    ...
    """
    2D backpropagation algorithm using the Fourier diffraction theorem
    ...
    if coords is not None:
        raise NotImplementedError("Output coordinates cannot yet be set "+
                                  + "for the 2D backpropagation algorithm.")
    ...
    # speeds up Fourier transforms if the input image size is not
    # a power of 2
