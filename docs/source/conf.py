...
MOCK_MODULES = ['numpy', 'scipy', 'fabio', 'h5py', 'matplotlib', 'matplotlib.pyplot', 'pyfftw', 'roipoly', 'math', 'scikit-image', 'libtiff', 'silx','pyopencl']
...
rst_epilog = """
.. |toupy| replace:: Toupy
.. _toupy: http://www.github.com/jcesardasilva/toupy
"""
...
# of the sidebar.
html_logo = '../../resources/toupy_logo.png'
...
latex_documents = [
    (master_doc, '{0}.tex'.format(project), 'Toupy Documentation',
     'Julio C. da Silva', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../../resources/toupy_logo.png'
