...
if __name__ == '__main__':
    ...
    a = raw_input(
        'Are you happy with the correction of the amplitude projections?([y]/n) ').lower()
    if a == '' or a == 'y':
        save_or_load_data('air_corrected_amplitude.h5',
                          stack_phasecorr, theta, pixelsize, **inputparams)
    else:
