...
if __name__=='__main__':
    ...
    inputparams.update(inputkwargs) # as second to update to the most recent values

    # load the reconstructed phase projections
    stack_objs,theta,deltastack,pixelsize,kwargs= save_or_load_data('reconstructed_projections.h5',**inputparams)
    ...
    if a == '' or a == 'y':
        ...
        stack_objs = stack_objs[:-a1] # the 3 last angles are 180, 90 and 0 degrees
    ...
    a = raw_input('Are you happy with the correction of the amplitude projections?([y]/n) ').lower()
    if a == '' or a == 'y':
        save_or_load_data('air_corrected_amplitude.h5',stack_phasecorr,theta,pixelsize,**inputparams)
    else:
