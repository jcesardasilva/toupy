...
if __name__ == '__main__':
    ...
    if params['derivatives']:
        a = input(
            'Do you want to proceed with the derivative calculation? ([y]/n) :').lower()
        if str(a) == '' or str(a) == 'y':
            ...
            a = input(
                'Do you want to display the calculated derivatives projections? ([y]/n): ').lower()
        else:
            raise SystemExit(
        ...
        a = input(
            'Do you want to display the cropped projections? ([y]/n): ').lower()
