...
if regfsc[0] != 0 and regfsc[1] != 0:
    ...
    offset_image2FSC = offset_image2[regfsc[0]
        :-regfsc[0], regfsc[1]:-regfsc[1]]
...
FSC2D = FSCPlot(image1FSC, offset_image2FSC.real, 'onebit',
                params['thick_ring'], apod_width=params['apod_width'])
...
print("------------------------------------------")
print("| Resolution is estimated to be {:.02f} nm |".format(
