...
if __name__ == "__main__":
    ...
    if params[u"oldfileformat"]:
        ...
        aligned_projections, theta, pixelsize = load_data_FSC(filename, **inputparams)
    else:
    ...
    t0 = time.time()
    tomogram1 = mod_iradon(
        sinogram_align1,
        theta=theta1,
        output_size=sinogram_align1.shape[0],
    ...
    t0 = time.time()
    tomogram2 = mod_iradon(
        sinogram_align2,
        theta=theta2,
        output_size=sinogram_align2.shape[0],
        filter_type=params["filtertype"],
        derivative=params[u"derivatives"],
        freqcutoff=params["filtertomo"],
    )
    ...
    print("------------------------------------------")
    print(
        "| Resolution is estimated to be {:.2f} nm |".format(
